// Service Worker de "Entradas y Salidas de Stock"
// Objetivo: que la app ABRA instantáneamente aunque no haya señal, para
// poder seguir registrando movimientos (quedan en cola y se suben solos).
...
const CACHE_NAME = 'stock-entradas-salidas-v10';
const ASSETS = [
  './',
  './index.html',
